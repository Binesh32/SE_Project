                ...
                <form class="shop-register"  action="{{ route('updateAdmin.profile', $editPost->id) }}" class="form mb-15" method="post"
                    ...
                    <div class="col-sm-12">
                        ...
                        <a class="theme_button color1 wide_button"
                            style="margin-left: 61rem;"href="{{ route('home') }}">Home</a>
                        <p class="divider_20 text-center">
                            Create an account <a href="{{ route('usersignup') }}">User</a>, <a
                                href="{{ route('organizationsignup') }}">Organization</a>or <a
                                href="{{ route('adminsignup') }}">Admin</a>
                            </a>
                        </p>
