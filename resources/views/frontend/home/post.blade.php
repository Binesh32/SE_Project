    ...
    <section id="posts" class="ls ms section_padding_100">
        ...
        <div class="container">
            ...
            <div class="col-sm-12 text-center">
                ...
                <h2>All the things <a href="{{ route('createpost') }}" class="text grey"
                        style="text-decoration: underline;">Create Post?</a></h2>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-sm-6">
                    ...
                    <p class="card-text" style="color: black;">This is the description of the post. Lorem ipsum dolor sit,
                        amet consectetur adipisicing elit. Voluptatibus aut aliquam fugiat iste dolore sit et aspernatur
                        suscipit! Deleniti saepe blanditiis quia nobis voluptatum explicabo non soluta harum vitae eaque!
                    </p>
                    <p class="card-text" style="color: black;"><b>Waste Type:</b> Organic</p>
                </div>
            </div>
            <form action="{{ route('comment.Post') }}" class="form mb-15" method="post"
            id="kt_contact_form" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <textarea id="comment-text" class="form-control" name = "comment" placeholder="Write a comment" style="background-color: lightgrey;"></textarea>
